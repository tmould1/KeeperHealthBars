...
namespace HealthBars.Scripts
{
    ...
    {
        private static Vector3 _HealthBarOffset { get; set; } = new Vector3(0f, 0f, 0f);
        ...
        public static void Init()
        {
            ...
            _HealthBarOffset = RegisterAndGet("HealthBarOffset", "Offset of health bars.", new Vector3(0f, 0f, 0f));
